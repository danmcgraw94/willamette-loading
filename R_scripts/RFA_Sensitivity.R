...
stage_res_condition <- rfa_sensitivity_plot(rfa_long, "Reservoir Guide Curve")
...
ggsave(file.path(plotdir,"Reservoir_Conditions.png"), stage_res_condition, height = 6, width = 8, dpi = 500)
...
ops_data <- rfa_long %>% 
  filter(sensitivity == "Reservoir Operations")
...
# Save -------------------------------------------------------------------------
ggsave(file.path(plotdir,"Reservoir_Operations.png"), stage_ops, height = 6, width = 8, dpi = 500)
